      ...
      <div className="flex justify-center items-center p-2.5 w-full text-base text-neutral-100">
        <div className="flex gap-5 justify-between w-full max-w-[1194px] max-md:flex-wrap max-md:max-w-full max-md:gap-3">
          ...
          <div className="flex gap-3.5 items-center max-md:gap-1">
            <Link to="/login" className="flex justify-center items-center p-2 text-base md:text-lg lg:text-xl ">
              <div>Sign in</div>
            </Link>
            <Link to="/signup" className="flex justify-center items-center p-2.5 text-base md:text-lg lg:text-xl border border-solid border-neutral-400 rounded-lg">
              <div>Sign up</div>
            </Link>
          </div>
        </div>
